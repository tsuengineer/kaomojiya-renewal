...
return [
    ...
    "between.array" => ":Min ~ :max 個である必要があります。",
    "between.file" => "ファイルサイズは :min ~ :max KBの間である必要があります。",
    "between.numeric" => ":Min ~ :max の間である必要があります。",
    "between.string" => "文字数は:Min ~ :max 文字の間である必要があります。",
    ...
    "file" => "ファイルである必要があります。",
    "filled" => "値がありません。",
    "gt.array" => "項目数は、:Value個より多い必要があります。",
    "gt.file" => "ファイルサイズは、:value KBより大きい必要があります。",
    "gt.numeric" => ":Value より大きい必要があります。",
    "gt.string" => ":Value文字より多い必要があります。",
    "gte.array" => ":Value 個以上である必要があります。",
    "gte.file" => "ファイルサイズが :value KB以上である必要があります。",
    "gte.numeric" => ":Value 以上である必要があります。",
    "gte.string" => ":Value文字以上必要です。",
    ...
    "lt.array" => ":Value 個より少ない必要があります。",
    "lt.file" => "ファイルサイズは :value KBより小さい必要があります。",
    "lt.numeric" => ":Value より小さい必要があります。",
    "lt.string" => ":Value文字より少ない必要があります。",
    "lte.array" => ":Value 個以下である必要があります。",
    "lte.file" => "ファイルサイズが :value KB以下である必要があります。",
    "lte.numeric" => ":Value 以下である必要があります。",
    ...
    "password.symbols" => "この項目は記号を1文字以上含む必要があります。",
    "password.uncompromised" => "この項目は情報漏洩した可能性があります。他の項目を選んでください。",
    "present" => "この項目は必須です。",
    ...
    "same" => ":Otherの値と一致しません。",
    "size.array" => ":Size 個である必要があります。",
    "size.file" => ":Size KBである必要があります。",
    "size.numeric" => ":Size である必要があります。",
    "size.string" => ":Size 文字である必要があります。",
