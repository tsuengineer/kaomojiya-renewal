...
return [
    ...
    "gte.file" => "This field must be greater than or equal :value kilobytes.",
    "gte.numeric" => "This field must be greater than or equal :value.",
    "gte.string" => "This field must be greater than or equal :value characters.",
    ...
    "lte.file" => "This field must be less than or equal :value kilobytes.",
    "lte.numeric" => "This field must be less than or equal :value.",
    "lte.string" => "This field must be less than or equal :value characters.",
    "mac_address" => "This field must be a valid MAC address.",
    "max.array" => "This field may not have more than :max items.",
    "max.file" => "This field may not be greater than :max kilobytes.",
    "max.numeric" => "This field may not be greater than :max.",
    "max.string" => "This field may not be greater than :max characters.",
